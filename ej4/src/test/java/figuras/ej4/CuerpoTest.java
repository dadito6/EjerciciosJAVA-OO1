...
public class CuerpoTest {
	private Cuerpos3D cilindro;
	private Cuerpos3D prisma;
	...
	public void testSuperficieExterior() {
		assertEquals( 0, prisma.getSuperficieExterior());
		...
		assertEquals(0 , superficieRedondeado);
	...
	public void testVolumen() {
		...
		assertEquals(volumenRedondeado, esperadoRedondeado - 141.37);
		
		assertEquals(0, prisma.getVolumen());
	}
