...
public boolean overlaps(timeLaps another) {
	return !(this.getFrom().isAfter(another.getFrom()) && this.getFrom().isAfter(another.getTo())
			|| this.getTo().isBefore(another.getFrom()) && this.getTo().isBefore(another.getTo()));
}
